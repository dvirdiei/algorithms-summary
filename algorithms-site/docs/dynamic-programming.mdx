  ...
  <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
    <div style={{ flex: '0 0 400px' }}>
      <svg viewBox="0 0 400 600" style={{ width: '100%', height: 'auto', background: 'rgba(0,0,0,0.1)', borderRadius: '12px', padding: '1rem' }}>
        ...
        <text x="200" y="220" fill="#f97316" fontSize="11" textAnchor="middle">F(3) מחושב 2 פעמים! F(2) מחושב 3 פעמים!</text>
        ...
        {/* DP - טבלה */}
        <text x="200" y="295" fill="#64f6c8" fontSize="16" fontWeight="bold" textAnchor="middle"> תכנון דינמי: O(n)</text>
        ...
        <g transform="translate(50, 320)">
          {[0, 1, 1, 2, 3, 5].map((val, i) => (
            <g key={i}>
              ...
              <text x={i * 50 + 22} y="42" fill="#fbbf24" fontSize="14" fontWeight="bold" textAnchor="middle">
                {val}
              </text>
            </g>
          ))}
        ...
        <text x="200" y="395" fill="#64f6c8" fontSize="11" textAnchor="middle"> כל ערך מחושב פעם אחת בלבד!</text>

        {/* קוד פסאודו */}
        <rect x="20" y="415" width="360" height="160" fill="rgba(0,0,0,0.3)" stroke="#a78bfa" strokeWidth="2" rx="8" />
        <text x="200" y="435" fill="#a78bfa" fontSize="13" fontWeight="bold" textAnchor="middle"> Bottom-Up Approach</text>
        <text x="200" y="460" fill="#64f6c8" fontSize="11" fontFamily="monospace">dp[0] = 0</text>
        <text x="200" y="478" fill="#64f6c8" fontSize="11" fontFamily="monospace">dp[1] = 1</text>
        <text x="200" y="496" fill="#fbbf24" fontSize="11" fontFamily="monospace">for i = 2 to n:</text>
        <text x="280" y="514" fill="#fbbf24" fontSize="11" fontFamily="monospace">dp[i] = dp[i-1] + dp[i-2]</text>
        <text x="200" y="532" fill="#64f6c8" fontSize="11" fontFamily="monospace">return dp[n]</text>
        <text x="200" y="560" fill="#a78bfa" fontSize="10" textAnchor="middle"> זמן: O(n), זיכרון: O(n) → ניתן לשפר ל-O(1)!</text>
</svg>
    </div>
